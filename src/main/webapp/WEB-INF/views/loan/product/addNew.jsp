...
<form id="addNew_form" class="form-horizontal" action="${ctx}/loan/product/save" method="post">
	<div class="form-group col-md-4">
		...
		<div class="col-md-8 input-group">
			...
			<input class="form-control input-large" type="text" id="category" name="category.fullName"  />
	...
	<div class="form-group col-md-8">
		...
		<div class="col-md-10 no-padding-left">
			<input type="text" class="form-control" id="instalments" name="instalments" maxlength="64"/> 
		</div>
	</div>
	<div class="form-group col-md-4">
	...
	<div class="form-group col-md-4">
		...
		<div class="col-md-8">
			<input type="text" class="input-xlarge" id="minLimit" name="minLimit"/> 
		</div>
	</div>
	<div class="form-group col-md-4">
		<label class="col-md-4 control-label no-padding-right" for="maxLimit">合同上限：</label>
		<div class="col-md-8">
			<input type="text" class="input-xlarge" id="maxLimit" name="maxLimit"/> 
		</div>
	</div>
<!-- 	<div class="form-group col-md-12" > -->
<!-- 		<label class="col-md-2 control-label no-padding-right" for="principalFormula"><span style="color: red">*</span>出借本金公式名称：</label> -->
<!-- 		<div class="col-md-10"> -->
<!-- 			<input type="text" id="principalFormulaName" name="principalFormulaName" maxlength="1024" class="form-control" required readonly="readonly"/> -->
<!-- 		</div> -->
<!-- 	</div> -->
	<div class="form-group col-md-12" >
		<label class="col-md-2 control-label no-padding-right" for="principalFormula"><span style="color: red">*</span>出借本金公式：</label>
		<div class="col-md-10">
			<input type="text" id="principalFormula" name="principalFormula" maxlength="512" class="form-control" required/>
		</div>
	</div>
	<div class="form-group col-md-12">
		...
		<div class="radio">
			<label>
				<input id="dayPaymentWay" name="dayPaymentWay" type="radio" value="1" checked="checked"/>
				<span class="lbl">起息日+分期</span>
			</label>
			<label>
				<input name="dayPaymentWay" type="radio" value="2" />
				<span class="lbl">自定义还款</span>
			</label>
		</div>
	</div>
	<div id="cusDayPaymentWay" class="hide">
		<div class="form-group col-md-4">
			<label class="col-md-4 control-label no-padding-right" for="useableDayPayment">可用还款日：</label>
			<div class="col-md-8">
				<input type="text" class="input-xlarge" id="useableDayPayment" name="useableDayPayment" maxlength="64"/> 
			</div>
		</div>
		<div class="form-group col-md-4">
			...
			<div class="radio">
				<label>
					<input name="firstPeriodWay" type="radio" value="1"/>
					<span class="lbl">靠上档</span>
				</label>
				<label>
					<input name="firstPeriodWay" type="radio" value="2" />
		...
		<div class="form-group col-md-4">
			...
			<div class="radio">
				<label>
					<input name="firstPeriodInterestWay" type="radio" value="1" />
					<span class="lbl">按期计算</span>
				</label>
				<label>
					<input name="firstPeriodInterestWay" type="radio" value="2" />
	...
	<div class="form-group col-md-6">
		...
		<div class="col-md-8 input-group bootstrap-timepicker">
			<input id="saleTime" name="saleTime" type="text" class="form-control" />
	...
	<div class="form-group col-md-6">
		...
		<div class="col-md-8 input-group bootstrap-timepicker">
			<input id="offTime" name="offTime" type="text" class="form-control" />
			<span class="input-group-addon">
				<i class="fa fa-clock-o bigger-110"></i>
			</span>
		</div>
...
<script type="text/javascript">
	$(function() {
		$("input[name='dayPaymentWay']").click(function(data){
			if ($(this).val() == 2) {
